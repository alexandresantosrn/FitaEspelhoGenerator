...
public class TamanhoCampos {
	...
	public final static int FILLER2 = 5;
	public final static int FILLER3 = 24;
	public final static int ENDERECO = 40;
	public final static int NUMERO = 6;
	public final static int COMPLEMENTO = 21;
	public final static int BAIRRO = 25;
	public final static int MUNICIPIO = 30;
	public final static int RG = 14;
	public final static int ORGAO_EXPEDIDOR = 5;
	public final static int TITULO_ELEITOR = 13;
	public final static int FILLER4 = 395;
	public final static int AGENCIA = 6;
