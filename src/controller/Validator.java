...
public class Validator {
	...
	public void validateDadosPessoais(Servidor servidor) {
		...
		if (temp.length() <= tamanhoFinalString) {
			...
			MensagensUtil.errosValidacao.add("Linha " + servidor.getLinhaArquivo() + " ->  Nome da m„e com " + temp.length()
		...
		if (temp.length() <= tamanhoFinalString) {
			...
			MensagensUtil.errosValidacao.add("Linha " + servidor.getLinhaArquivo() + " ->  EndereÁo com " + temp.length()
					+ " caracteres (" + temp + ")" + ". Deveria ter no m·ximo " + tamanhoFinalString + " caracteres.");
		}
		...
		if (temp.length() <= tamanhoFinalString) {
			...
			MensagensUtil.errosValidacao.add("Linha " + servidor.getLinhaArquivo() + " ->  MunicÌpio com " + temp.length()
					+ " caracteres (" + temp + ")" + ". Deveria ter no m·ximo " + tamanhoFinalString + " caracteres.");
		}
		...
		if (temp.length() <= tamanhoFinalString) {
			...
			MensagensUtil.errosValidacao.add("Linha " + servidor.getLinhaArquivo() + " ->  N˙mero RG com " + temp.length()
					+ " caracteres (" + temp + ")" + ". Deveria ter no m·ximo " + tamanhoFinalString + " caracteres.");
		}
